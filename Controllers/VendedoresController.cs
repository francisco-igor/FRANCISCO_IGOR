...
namespace FRANCISCO_IGOR.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Contato")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Contato")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();

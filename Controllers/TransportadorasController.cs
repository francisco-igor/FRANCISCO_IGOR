...
namespace FRANCISCO_IGOR.Controllers
{
    public class TransportadorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Sede")] Transportadora transportadora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sede")] Transportadora transportadora)
        {
